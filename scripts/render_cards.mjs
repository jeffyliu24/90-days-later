...
const footer = (page) => `${line(72, 1572, 1170, 1572, C.line, 2)}
  ...
  ${text(1170, 1618, `${page} / 7`, 26, C.muted, 500, 'end')}`;
...
function cover() {
  return shell(`
    ...
    ${text(72, 535, 'WORLD MONITOR', 44, C.blue, 500)}
...
async function render() {
  ...
  const cards = [
    ['01-cover', cover()],
    ['02-then-now', thenNow()],
    ['03-star-timeline', await starTimeline()],
    ['04-hype-retention', hypeRetention()],
    ['05-maintenance', maintenance()],
    ['06-why-not-a', whyNotA()],
    ['07-verdict', verdict()],
  ];
